-- Admin kunne kun tilsidesætte dagskapaciteten (max_animals_per_day),
-- ikke kapaciteten pr. interval (max_animals_per_slot) — capacity_override
-- havde ingen effekt der. UI'et havde heller ingen knap til at sætte
-- capacity_override overhovedet; den er tilføjet i bookingformularen
-- (kun synlig for admin). Fejlteksterne er samtidig omdøbt fra "slot"
-- til "interval", jf. den generelle terminologiændring i UI'et.
